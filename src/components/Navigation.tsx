      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center cursor-pointer" onClick={() => navigate("/")}>
            <div className="text-2xl font-bold">
              <span className="text-foreground my-0">Dubai</span>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-80 p-2 bg-popover border-border shadow-luxury">
                <div className="grid grid-cols-1 gap-1">
                  ...
                  return <DropdownMenuItem key={service.name} onClick={() => handleServiceClick(service.href)} className="flex items-start space-x-3 p-3 cursor-pointer hover:bg-accent/50 rounded-md transition-colors">
        ...
        {isOpen && <div className="md:hidden py-4 border-t border-border">
            <div className="flex flex-col space-y-4">
              ...
              const Icon = service.icon;
              return <button key={service.name} onClick={() => handleServiceClick(service.href)} className="flex items-center space-x-3 w-full px-3 py-2 text-left hover:bg-accent/50 rounded-md transition-colors">
              ...
              <a href="#pricing" className="text-muted-foreground hover:text-foreground transition-colors px-3 py-2" onClick={() => setIsOpen(false)}>
                Pricing
              </a>
              {user ? <>
